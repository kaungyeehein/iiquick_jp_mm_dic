 ...
 * @license GPL
 */
public class IncreaseIncorrectAction extends ActionSupport {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		String result = "fail";
		 ...
		 try{
			 dao.increaseIncorrect(table, id);
			 result = "success";
		 } catch (Exception e) {
			 e.printStackTrace();
			 result = "fail";
		...
		if (result.equals("success")) {
			System.out.println("IncreaseIncorrectAction:success " +table+" "+id);
		} else {
			System.err.println("IncreaseIncorrectAction:fail");
		}
