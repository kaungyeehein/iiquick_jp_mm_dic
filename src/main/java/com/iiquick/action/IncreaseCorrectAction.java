 ...
 * @license GPL
 */
public class IncreaseCorrectAction extends ActionSupport {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		if (result.equals("success")) {
			System.out.println("IncreaseCorrectAction:success " +table+" "+id);
		} else {
			System.err.println("IncreaseCorrectAction:fail");
		}
